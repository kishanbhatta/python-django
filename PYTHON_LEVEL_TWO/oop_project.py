...
class Player:
    ...
    def remove_war_cards(self):
        ...
        if len(self.hand.cards) < 3:
            ...
            for x in range(3):
                war_cards.append(self.hand.remove.cards())
            return war_cards
...
while user.still_has_cards() and comp.still_has_cards():
    ...
    # Create a table represented by list
    table_cards = []
    ...
    if c_card[1] == p_card[1]:
        ...
        print("Each player remove 3 cards 'face down' and then one card face up")
        ...
        if RANKS.index(c_card[1]) < RANKS.index(p_card[1]):
            print(user.name + " has the higher card, adding top hand.")
